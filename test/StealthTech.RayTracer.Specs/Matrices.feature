...
Scenario: Identity matrix 4x4 matrix
	Given the following matrix A:
		| 0 | 1 | 2  | 4  |
		| 1 | 2 | 4  | 8  |
		| 2 | 4 | 8  | 16 |
...
Scenario: Identity matrix 2x2 matrix
	Given the following matrix A:
		| 0 | 1 |
		| 1 | 2 |
	Then The identity of A is:
...
Scenario: A submatrix of a 3x3 matrix is a 2x2 matrix
	Given the following matrix A:
		...
		| -3 | 2 | 7  |
		| 0  | 6 | -3 |
	Then submatrix(A, 0, 2) is the following matrix:
		| -3 | 2 |
		| 0  | 6 |
...
Scenario: A submatrix of a 4x4 matrix is a 3x3 matrix
	Given the following matrix A:
		...
		| -1 | 0 | 8  | 2 |
		| -7 | 1 | -1 | 1 |
	Then submatrix(A, 2, 1) is the following matrix:
		| -6 | 1  | 6 |
		| -8 | 8  | 6 |
		| -7 | -1 | 1 |
